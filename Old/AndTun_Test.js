...
UI.AddCheckbox(["Rage", "AT AntiAim", "AT AntiAim"], "Sway Max Jitter");//峰值抖动
...
function AT_AntiAim_Changed() {
    if (AA_Mode == 0) {
        ...
        UI.SetEnabled(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"], 1);
        //定义当前AA
        switch (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "Now AA Mode"])) {
            case 0://Static
                ...
                UI.SetEnabled(["Rage", "AT AntiAim", "AT AntiAim", "Real Offset"], 1);//Real Offset
                UI.SetEnabled(["Rage", "AT AntiAim", "AT AntiAim", "Yaw Offset"], 1);//Yaw Offset
                UI.SetEnabled(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"], 0);
            ...
            case 1://Sway
                ...
                UI.SetEnabled(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"], 1);
                //不能低于0
                if (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"]) < 0) {
                    UI.SetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"], 0);
                }
                //Sway
                if (getVelocity(Entity.GetLocalPlayer()) < 3) {//站立
                    if (lbyDirection == 1) {
                        if (LBYOffset <= UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"])) {
                            //Max Jitter
                            LBYOffset += 1;
                            // if (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"]) == 1 && LBYOffset == UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"]) && count % 2 == 0) {
                            //     LBYOffset += 20;
                            //     count--;
                            // } else if (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"]) == 1) {
                            //     LBYOffset -= 20;
                            //     count--;
                            // }
                        } else {
                        ...
                        if (LBYOffset >= -UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"])) {
                            ...
                            //     LBYOffset -= 1;
                            //     count == 0;
                            // } else if (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"]) == 1 && LBYOffset == UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "LBY Offset"]) && count % 2 == 0) {
                            //     LBYOffset -= 20;
                            //     count--;
                            // } else if (UI.GetValue(["Rage", "AT AntiAim", "AT AntiAim", "Sway Max Jitter"]) == 1) {
                            //     LBYOffset += 20;
