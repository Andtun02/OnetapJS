/*====================
 ...
 function BuyList_ON() {
     ...
     var BuyListWepIco = Render.GetFont("AT-Weapons.ttf", 18, false);//武器图标
     ...
     Render.String(x + 126 + buyListmoveX, y - 1, 1, buyWhoGunList[1][0], [255,255,255,255], BuyListWepIco)//buylist
     Render.String(x + 126 + buyListmoveX, y + 22, 1, buyWhoGunList[1][1], [255,255,255,255], BuyListWepIco)//buylist
     Render.String(x + 126 + buyListmoveX, y + 42, 1, buyWhoGunList[1][2], [255,255,255,255], BuyListWepIco)//buylist
     Render.String(x + 126 + buyListmoveX, y + 62, 1, buyWhoGunList[1][3], [255,255,255,255], BuyListWepIco)//buylist
     Render.String(x + 126 + buyListmoveX, y + 82, 1, buyWhoGunList[1][4], [255,255,255,255], BuyListWepIco)//buylist
